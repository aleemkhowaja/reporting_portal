...
$.jgrid.extend({
	searchGrid : function (p) {
		...
		return this.each(function() {
			...
			if ( $("#"+IDs.themodal).html() !== null && $("#"+IDs.themodal).length > 0) {
				showFilter();
			} else {
	...
	navGrid : function (elem, o, pEdit,pAdd,pDel,pSearch, pView) {
		...
		return this.each(function() {
			...
			// PathSolutions Adding undefined condition since Omni Admin JQuery 3.x it is not returned as null TP 691090
			var alrtsModConstructed = $("#"+alertIDs.themodal).html();
			if (alrtsModConstructed === null || alrtsModConstructed == undefined) {
				...
				//#596764
				if(this.p.direction =='rtl' && $("#"+alertIDs.themodal).css("position") =='relative')
				{
					$("#"+alertIDs.themodal)[0].style.right = $("#"+alertIDs.themodal)[0].style.left;
					$("#"+alertIDs.themodal)[0].style.left	= "";
				}
			}
			var clone = 1;
