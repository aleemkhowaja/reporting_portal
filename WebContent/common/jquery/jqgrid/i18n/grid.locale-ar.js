...
$.jgrid = {
	defaults : {
		...
		viewtext: "تسجيل",
		toggletext: "تبديل",
		toggletitle: "تبديل شريط  البحث",
		cleartext: "نظف",
		cleartitle: "نظف البحث",
		oftext: "على",
		pgtext : "صفحة {0} على {1}"
	},
	search : {
		...
		Find: "بحث",
		Reset: "إلغاء",
		odata : ['يساوي', 'يختلف', 'أقل', 'أقل أو يساوي','أكبر','أكبر أو يساوي', 'يبدأ بـ','لا يبدأ بـ','ضمن','ليس ضمن','ينته بـ','لا ينته بـ','يحتوي','لا يحتوي','غير موجود','موجود'],
		groupOps: [	{ op: "AND", text: "الكل" },	{ op: "OR",  text: "أي" }	],
		matchText: " توافق",
		rulesText: " قواعد",
		addRuleText: "إضافة قاعدة",
		delRuleText: "حذف القاعدة"
	},
	edit : {
		addCaption: "اضافة",
		editCaption: "تحديث",
	...
	nav : {
		...
		resetUserPreferences:"إعادة تعيين تفضيلات المستخدم",
		setUserDefaultPreferences:"تثبيت تفضيلات المستخدمين"
	},
	col : {
