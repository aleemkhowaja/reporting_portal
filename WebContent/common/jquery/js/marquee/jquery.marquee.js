...
//Path Solutions
//Common function to handle customized default behaviour
//function scrollMarquee(divID, msg)
//{
...
//			$('#scrollingMarquee').marquee('destroy');
//			//Load new content using Ajax and update the marquee container
//			//i++;
//			$('#scrollingMarquee')//.html('Some new data loaded')
//				//Apply marquee plugin again
//			.marquee();
//		});
		
//		$.ajax( {
//			url : jQuery.contextPath + '/pathdesktop/portalDashboardAction_returnMarqueeMessages',
//			type : "post",
//			//data : labelParams,
//			success : function(response) {
//				if (response["_error"] == undefined	|| response["_error"] == null) {
//					var msgArray = response.marqueeMessages;
//					if(msgArray.length>0)
//						{
//						for(var j=0; j<msgArray.length; j++)
//							{
//								var iDiv = document.getElementById('scrollingMarquee')
//								
//								var innerDiv = document.createElement('div');
//								innerDiv.id = 'scrollingMarquee_'+j;
//								innerDiv.className = 'marquee';
//								iDiv.appendChild(innerDiv);
//								innerDiv.innerHTML = msgArray[j];
//							}
