...
$.widget( "ui.iviewer", $.ui.mouse, {
    ...
    loadImage: function( src )
    {
	        ...
	        if(src=="undefined"||src=="#")
	        	$(this.img_object._img).attr("alt",imgNotAvailable);
	        if(src!="#"){
    ...
    **/
    createui: function()
    {
		...
		var elementId =  $(this.container).attr("id");
         var toolbar =  $("<span>", { 'class': "iviewer-toolbar ui-widget-header ui-corner-all"})                    
                    .appendTo(this.container);
        
        
        $("<button>", { 'id':elementId+"_iviewer_zoom_in", 'class':"iviewer-button"})
                    .bind('click',function(){me.zoom_by(1); return false;})
                    .appendTo(toolbar);

        $("<button>", { 'id':elementId+"_iviewer_zoom_out", 'class':"iviewer-button"})
                    .bind('click',function(){me.zoom_by(- 1); return false;})
                    .appendTo(toolbar);
        
        $("<button>", { 'id':elementId+"_iviewer_zoom_zero", 'class':"iviewer-button"})
                    .bind('click',function(){me.set_zoom(100); return false;})
                    .appendTo(toolbar);
        
        $("<button>", { 'id':elementId+"_iviewer_zoom_fit", 'class':"iviewer-button"})
                    .bind('click',function(){me.fit(this); return false;})
                    .appendTo(toolbar);
        
      /*   this.zoom_object =$("<span>", { 'class': "iviewer_zoom_status "})                     
                    .appendTo(toolbar);
        */
         
        
        $("<button>", { 'id':elementId+"_iviewer_rotate_left", 'class':"iviewer-button"})
                    .bind('click',function(){me.angle(-90); return false;})
                    .appendTo(toolbar);
        
        $("<button>", { 'id':elementId+"_iviewer_rotate_right", 'class':"iviewer-button"})
                    .bind('click',function(){me.angle(90); return false;})
                    .appendTo(toolbar);
       //this.zoom_object = $("<span>",{'class':"iviewer_zoom_status"}).appendTo(toolbar);
        
        
         $( "#"+elementId+"_iviewer_zoom_in" ).button({
            text: false,
            icons: {
                primary: "ui-icon-zoomin"
            }
        });
        $( "#"+elementId+"_iviewer_zoom_out" ).button({
            text: false,
            icons: {
         ...
         $( "#"+elementId+"_iviewer_zoom_zero" ).button({
            text: false,
            icons: {
                primary: "ui-icon-extlink"
            }
        });
        $( "#"+elementId+"_iviewer_zoom_fit" ).button({
            text: false,
            icons: {
         ...
         $( "#"+elementId+"_iviewer_rotate_left" ).button({
            text: false,
            icons: {
                primary: "ui-icon-arrowreturnthick-1-w"
            }
        });
        $( "#"+elementId+"_iviewer_rotate_right" ).button({
            text: false,
            icons: {
