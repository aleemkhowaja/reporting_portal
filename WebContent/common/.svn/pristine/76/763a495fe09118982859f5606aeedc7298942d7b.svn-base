...
function buttonCustParamMapGrid_adjustMapValueResultList(mapTypeDesc,selectedRowId)
{
	if(mapTypeDesc == '1')
	{
		jQuery.globalEval("options_liveSearch_screenFldIdDesc_ButtonCustParamMapGrid_Id_"  + currentPageRef + ".resultList = 'FLD_IDENTIFIER:screenFldIdDesc_lookuptxt,FIELD_KEY_LABEL_CODE:mapDescription,FROM_SOURCE:fromSource'");
		
		if(openedFromDynamicScreen(currentPageRef))
		{
			jQuery.globalEval("options_liveSearch_screenFldIdDesc_ButtonCustParamMapGrid_Id_"  + currentPageRef + ".dataAction = '"+ jQuery.contextPath + "/path/dynamicScreen/dynScreenLookupAction_drawingDynScreenElementsGrid" +"'");
			jQuery.globalEval("options_liveSearch_screenFldIdDesc_ButtonCustParamMapGrid_Id_"  + currentPageRef + ".paramList = 'screenId:screenId'");
			jQuery.globalEval("options_liveSearch_screenFldIdDesc_ButtonCustParamMapGrid_Id_"  + currentPageRef + ".actionName = '"+ jQuery.contextPath + "/path/dynamicScreen/dynScreenLookupAction_drawingDynScreenElementsGrid" +"'");
			jQuery.globalEval("options_liveSearch_screenFldIdDesc_ButtonCustParamMapGrid_Id_"  + currentPageRef + ".resultList = 'elementIdValue:screenFldIdDesc_lookuptxt'"); 
			...
			for (var i = 0; i < colModel.length; i++)
			{
				...
				{
					colModel[i].dependencySrc = jQuery.contextPath + "/path/dynamicScreen/dynDependencyAction_dependencyByScreenElementId";
					colModel[i].dependency = "dynamicScreenCO.elementIdValue:screenFldIdDesc_lookuptxt,dynamicScreenCO.elementId:mapDescription";
					colModel[i].params = "dynamicScreenCO.screenIdValue:screenId,dynamicScreenCO.elementIdValue:screenFldIdDesc_lookuptxt";
					break;
				}
			}
	...
	else if( mapTypeDesc == '2' || mapTypeDesc == '9')
	{
		jQuery.globalEval("options_liveSearch_screenFldIdDesc_ButtonCustParamMapGrid_Id_"  + currentPageRef + ".resultList = 'propertyName:screenFldIdDesc_lookuptxt,description:mapDescription'");
	}
}
...
function buttonCustParamMapGrid_onRowSelTopic(rowObj)
{
	...
	enableDisableSelectionType(true);
...
function enableDisableSelectionType(fromRowSel)
{
	var $table = $("#ButtonCustParamMapGrid_Id_" + currentPageRef);
	var selectedRowId = $table.jqGrid('getGridParam', 'selrow');
	var selectedRowObject = $table.jqGrid('getRowData', selectedRowId);
	...
	var mapDirection = selectedRowObject["mapDirection"];
	if(("GRID" == fromSource || (fromRowSel && delimiter != null && delimiter != '' && delimiter != undefined)) && mapDirection =='I')
	{
