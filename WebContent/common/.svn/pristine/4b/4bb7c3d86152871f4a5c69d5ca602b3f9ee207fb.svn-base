	 ...
	 */
	function gridReload(lookupUrl,lookupDatatype,lookupPages,lookupTxt,gridtab,overlay,lookupId,lookupDiv,pagerid,spanLookup,searchCols,keylistvalues,tblCellId,_tblRowid){
		...
		$grid.jqGrid('setGridParam',{url:lookupUrl,datatype:lookupDatatype,postData: arr,page:lookupPages}).trigger("reloadGrid");
...
//									   		onSelectRow(_tblRowid,dynHdResultId, searchElement,null,null);//PathSolutions [Navas] [Commeneted and moved to above]
							...
							else
							{
				            	...
				            	gridReload(lookupUrl,'json',1,lookupTxt,gridtab,overlay,lookupId,lookupDiv,pagerid,spanLookup,srchCols,myData,tblCellId,_tblRowid);
