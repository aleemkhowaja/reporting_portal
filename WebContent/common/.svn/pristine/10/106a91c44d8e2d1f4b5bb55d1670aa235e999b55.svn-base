...
function fldcust_CheckVisbleRequired(element, what)
{
	...
	var fldDepVisible = "0";
	var fldcust_fromCollaps = $("#fldcust_fromCollaps_"+currPageRef).val();
	var fldcust_fromButton = $("#fldcust_fromButton_"+currPageRef).val();
	var fldcust_fromTab  = $("#fldcust_fromTab _"+currPageRef).val();
	// if Required Checked
...
{
	var fldcust_fromCommonScreen = $("#fldcust_fromCommonScreen_"+currPageRef).val();
	_showConfirmMsg(
...
function fieldCustomization_customLoadCombo(zUrl, zList, zId, zValue)
{
	...
	var custLoad_fromText = $("#fldcust_fromText_"+currPageRef).val();
	var custLoad_fromTextArea = $("#fldcust_fromTextArea_"+currPageRef).val();
	var custLoad_fromLiveSearch = $("#fldcust_fromLiveSearch_"+currPageRef).val();
