...
<#if (parameters.useHiddenProps?default('false') == 'true' || parameters.applyChangeTrack?default('false') == 'true') && parameters.exclTrackSecIds?if_exists != "" >
 exclTrk="${parameters.exclTrackSecIds?html}"<#rt/>
</#if>
