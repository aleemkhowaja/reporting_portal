...
>
	...
	<#assign initialValue = "${parameters.doubleHeaderKey?html}" /><#t/>
	<@s.iterator value="parameters.doubleList"><#t/>
        ...
        <#assign initialValue = initialValue+","+doubleItemKey.toString() /><#t/>
	...
	<input type="hidden" id="__initialValue_${parameters.doubleId?html}" name="__${parameters.id?html}" value="${initialValue}">
</select>
