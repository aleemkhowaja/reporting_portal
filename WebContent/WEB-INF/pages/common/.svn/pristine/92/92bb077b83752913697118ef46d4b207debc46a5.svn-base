...
<psjg:grid id="dynScreenParamMapGrid_Id_${_pageRef}"
	...
	<psjg:gridColumn id="sysParamElmDynScrnMapDet_MAP_VALUE" colType="liveSearch"
				...
				resultList="FLD_IDENTIFIER:sysParamElmDynScrnMapDet.MAP_VALUE_lookuptxt,FIELD_KEY_LABEL_CODE:mapValueDesc"
				...
				dependency="buttonCustomizationCO.sysParamActionArgMapVO.MAP_VALUE:sysParamElmDynScrnMapDet.MAP_VALUE_lookuptxt,buttonCustomizationCO.sysParamBtnCustVO.DESCRIPTION:mapValueDesc" 
				/>		
